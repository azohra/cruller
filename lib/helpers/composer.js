...
const getValidStampStrings = ({folder: folder, section: section, envMap: envMap}) => {
    ...
    for (let stamp of stamps) {  
        try {
            ...
            console.log(`Stamp composition failed. This is due to ${stamp} that is not properly referenced. This may be due to a typo in the stamp name, or a typo/omission from index.js`);
